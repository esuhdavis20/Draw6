...
class mainMenu():
    ...
    smallfont2 = pygame.font.SysFont('CASTELLAR',30, bold = True)

    #text = smallfont.render('START GAME' , True , color)
    text2 = smallfont.render('GAME RULES', True, GOLD_COLOR)

    # Deck Size Options Code
    text3 = smallfont2.render('Deck Size Options: ', True, WHITE_COLOR)
    text4 = smallfont2.render('One', True, GOLD_COLOR)
    deck1 = smallfont2.render('Deck Size Set To: One', True, WHITE_COLOR)
    text5 = smallfont2.render('Two', True, GOLD_COLOR)
    deck2 = smallfont2.render('Deck Size Set To: Two', True, WHITE_COLOR)
    text6 = smallfont2.render('Four', True, GOLD_COLOR)
    deck4 = smallfont2.render('Deck Size Set To: Four', True, WHITE_COLOR)
    text7 = smallfont2.render('Six', True, GOLD_COLOR)
    deck6 = smallfont2.render('Deck Size Set To: Six', True, WHITE_COLOR)
    text8 = smallfont2.render('Eight ', True, GOLD_COLOR)
    deck8 = smallfont2.render('Deck Size Set To: Eight', True, WHITE_COLOR)
    ...
    while running:            
        for ev in pygame.event.get():
            ...
            if ev.type == pygame.MOUSEBUTTONDOWN:
                ...
                if x_pos + 250 <= mouse[0] <= x_pos + 950 and y_pos + 50 <= mouse[1] <= y_pos + 90:
                    running = False
                    __name__ = "__main__"
                elif x_pos + 300 <= mouse[0] <= x_pos + 750 and y_pos + -30 <= mouse[1] <= y_pos + 30:
                    #running = False
                ...
                elif x_pos + 450 <= mouse[0] <= x_pos + 540 and y_pos + 140 <= mouse[1] <= y_pos + 200:
                    screen.blit(deck1 ,(x_pos + 380, y_pos - 100))
                    pygame.display.flip()
                    pygame.time.delay(1150)
                elif x_pos + 560 <= mouse[0] <= x_pos + 640 and y_pos + 140 <= mouse[1] <= y_pos + 200:
                    screen.blit(deck2 ,(x_pos + 380, y_pos - 100))
                    pygame.display.flip()
                    pygame.time.delay(1150)
                elif x_pos + 660 <= mouse[0] <= x_pos + 770 and y_pos + 140 <= mouse[1] <= y_pos + 200:
                    screen.blit(deck4 ,(x_pos + 380, y_pos - 100))
                    pygame.display.flip()
                    pygame.time.delay(1150)
                elif x_pos + 790 <= mouse[0] <= x_pos + 870 and y_pos + 140 <= mouse[1] <= y_pos + 200:
                    screen.blit(deck6 ,(x_pos + 380, y_pos - 100))
                    pygame.display.flip()
                    pygame.time.delay(1150)
                elif x_pos + 900 <= mouse[0] <= x_pos + 990 and y_pos + 140 <= mouse[1] <= y_pos + 200:
                    screen.blit(deck8 ,(x_pos + 380, y_pos - 100))
                    pygame.display.flip()
                    pygame.time.delay(1150)
        ...
        screen.blit(text2 ,(x_pos + 410, y_pos + -20))
        screen.blit(text3 ,(x_pos + 80, y_pos + 130))
        screen.blit(text4 ,(x_pos + 480, y_pos + 130))
        screen.blit(text5 ,(x_pos + 580, y_pos + 130))
        screen.blit(text6 ,(x_pos + 690, y_pos + 130))
        screen.blit(text7 ,(x_pos + 815, y_pos + 130))
        screen.blit(text8 ,(x_pos + 895, y_pos + 130))
...
class BlackJack(object):
    ...
    common_vars.text2_font = pygame.font.SysFont('Courier New', 35, bold=True)
