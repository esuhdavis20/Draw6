    ...
    for index_x, hand in enumerate(player_hands):
        ...
        if hands_status[hand + 'blackjack']:
            ...
            screen.blit(image_db.get_image(IMAGE_PATH + "push.png"),
                        (player_x_pos + x_offset, player_y_pos + y_offset))
        elif hands_status[hand + 'lose']:
            screen.blit(image_db.get_image(IMAGE_PATH + "you_lose.xcf"),
                        (player_x_pos + x_offset, player_y_pos + y_offset))
...
def plot_buttons(screen, button_status):
    ...
    if button_status.play is True:
        screen.blit(image_db.get_image(IMAGE_PATH_BUTTONS + PLAY_BUTTON_FILENAME_ON),
                    (button_x_pos + 200, button_y_pos - 15))
    else:
    ...
    if button_status.undo_bet is True:
        screen.blit(image_db.get_image(IMAGE_PATH_BUTTONS + UNDO_BET_BUTTON_FILENAME_ON),
                    (button_x_pos + 335, button_y_pos - 15))
    else:
    ...
    if button_status.assist is True:
        screen.blit(image_db.get_image(IMAGE_PATH_BUTTONS + ASSIST_BUTTON_FILENAME_ON),
                    (button_x_pos - 890, button_y_pos - 7))
...
def plot_results(screen, text_font, message):
    ...
    screen.blit(text_to_plot, (x_pos + 5, y_pos + 103))
...
class ButtonCollideArea:
    ...
    def __init__(self, common_vars):
        ...
        self.play_button_area = pygame.Rect(button_x_pos + 200,
                                            button_y_pos - 15,
                                            common_vars.button_image_width,
                                            common_vars.button_image_height)
        button_x_pos += GAP_BETWEEN_BUTTONS
        self.undo_bet_button_area = pygame.Rect(button_x_pos + 335,
                                                button_y_pos - 15,
                                                common_vars.button_image_width,
                                                common_vars.button_image_height)
        button_x_pos += GAP_BETWEEN_BUTTONS
        self.hit_button_area = pygame.Rect(button_x_pos - 120,
                                           button_y_pos - 80,
                                           common_vars.button_image_width,
                                           common_vars.button_image_height)
        button_x_pos += GAP_BETWEEN_BUTTONS
        self.stand_button_area = pygame.Rect(button_x_pos - 120,
                                             button_y_pos - 80,
                                             common_vars.button_image_width,
                                             common_vars.button_image_height)
        button_x_pos += GAP_BETWEEN_BUTTONS
        self.split_button_area = pygame.Rect(button_x_pos - 120,
                                             button_y_pos - 80,
                                             common_vars.button_image_width,
                                             common_vars.button_image_height)
        button_x_pos += GAP_BETWEEN_BUTTONS
        self.double_down_button_area = pygame.Rect(button_x_pos - 120,
                                                   button_y_pos - 80,
                                                   common_vars.button_image_width,
                                                   common_vars.button_image_height)
        button_x_pos += GAP_BETWEEN_BUTTONS
